...
CREATE TABLE `wechat_config` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `app_id` varchar(100) COLLATE utf8_unicode_ci NOT NULL COMMENT '开发者ID(AppID)',
  `token` varchar(100) COLLATE utf8_unicode_ci NOT NULL COMMENT '令牌(Token)',
  `appsecret` varchar(100) COLLATE utf8_unicode_ci NOT NULL COMMENT '开发者密码(AppSecret)',
  `code` varchar(100) COLLATE utf8_unicode_ci NOT NULL COMMENT '编码：指定属于公众号，还是小程序，还是微信支付',
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='微信相关配置，计划把公众号，小程序，微信支付的接入配置保存在这张表，每种接入配置只会保留一条';
